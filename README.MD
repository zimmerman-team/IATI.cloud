...
Please make sure your python version is 3.6.x.
...
5. Install ```Postgres``` and ```PostGIS```. Please refer to 
<a href="https://postgis.net/install/" target="_blank">this website</a> for 
installation.
