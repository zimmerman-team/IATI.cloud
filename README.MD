...
3. Start the server: ```./manage.py runserver localhost:8000``` 
...
6. Follow instructions for sign-in: http://docs.oipa.nl/en/latest/admin_interface/
7. Finally, follow the instructions from here: http://docs.oipa.nl/en/latest/where_to_start/
Happy Hunting!
