...
class WBI_Parser():
    ...
    def get_topic_or_create(self, topic_name):
        res, created = indicator_topic.objects.get_or_create(name=topic_name)
        return res


    def get_source_or_create(self, source_name):
        res, created = indicator_source.objects.get_or_create(name=source_name)
        return res
