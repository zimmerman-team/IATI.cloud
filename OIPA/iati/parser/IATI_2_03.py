...
class Parse(IatiParser):
    ...
    def iati_activities__iati_activity__recipient_country(self, element):
        ...
        #         "iati-activity",
        #         "recipient-country",
        #         "activity/recipient-country must not used if transaction/recipient-country is used.",  # NOQA: E501
        #
        #     )
    ...
    def iati_activities__iati_activity__result__indicator__period__target(
        ...
        try:
            ...
            # We have update the codes in api aggregations to enable null
    ...
    def iati_activities__iati_activity__result__indicator__period__actual(
        ...
        try:
            ...
            # We have updated the api aggregations to enable null
