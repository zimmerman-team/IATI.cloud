    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iati_identifier', models.CharField(max_length=150, db_index=True)),
                ('hierarchy', models.SmallIntegerField(default=1, null=True, choices=[(1, 'activity'), (2, 'sub-activity'), (3, 'sub-sub-activity')])),
