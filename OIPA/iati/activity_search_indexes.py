...
def reindex_activity(activity):
    ...
    combined_vector = SearchVector('iati_identifier', config='english') + SearchVector('title', config='english') + SearchVector('description', config='english') + SearchVector('reporting_org', config='english') + SearchVector('participating_org', config='english') + SearchVector('recipient_country', config='english') + SearchVector('recipient_region', config='english') + SearchVector('sector', config='english') + SearchVector('document_link', config='english')   
