...
class TransactionProviderInline(nested_admin.NestedStackedInline):
    ...
    classes = ('collapse open',)
    inline_classes = ('collapse open',)
    exclude = ('normalized_ref', 'organisation',
               'provider_activity', 'primary_name')
    ...
    def save_model(self, request, obj, form, change):
        ...
        return super(TransactionProviderInline, self).save_model(
...
class TransactionReceiverInline(nested_admin.NestedStackedInline):
    ...
    inline_classes = ('collapse open',)
    exclude = ('normalized_ref', 'organisation',
               'receiver_activity', 'primary_name')
    ...
    def save_model(self, request, obj, form, change):
        ...
        return super(TransactionReceiverInline, self).save_model(
            request, obj, form, change)
...
class ActivityParticipatingOrganisationInline(
...
class ResultInline(nested_admin.NestedStackedInline):
    ...
    fields = ('read_title', 'type', 'aggregation_status',
              'read_description', 'edit_result',)
...
class ActivityAdmin(nested_admin.NestedModelAdmin):
    ...
    def get_inline_instances(self, request, obj=None):
        ...
        inline_instances = super(
            ActivityAdmin, self).get_inline_instances(request, obj)
    ...
    def save_related(self, request, form, formsets, change):
        super(ActivityAdmin, self).save_related(
...
class TransactionAdmin(nested_admin.NestedModelAdmin):
    ...
    def get_inline_instances(self, request, obj=None):
        ...
        inline_instances = super(
            TransactionAdmin, self).get_inline_instances(request, obj)
    ...
    def save_formset(self, request, form, formset, change):
        ...
        super(TransactionAdmin, self).save_formset(
    ...
    def save_related(self, request, form, formsets, change):
        super(TransactionAdmin, self).save_related(
            request, form, formsets, change)
...
class ResultIndicatorPeriodTargetCommentInline(
        nested_admin.NestedStackedInline):
...
class ResultIndicatorPeriodActualCommentInline(
        nested_admin.NestedStackedInline):
...
class ResultAdmin(nested_admin.NestedModelAdmin):
    ...
    def get_inline_instances(self, request, obj=None):
        ...
        inline_instances = super(
            ResultAdmin, self).get_inline_instances(request, obj)
