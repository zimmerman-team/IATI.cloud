...
class Parser():
    ...
    def add_activity_search_data(self, activity):
        ...
        for title in activity.title_set.all():
            search_data.search_title = '{orig_title} {add_title} '.format(
                orig_title=search_data.search_title or '',
                add_title=title.title or ''
            )

        for description in activity.description_set.all():
            search_data.search_title = '{orig_description} {add_description} '.format(
        ...
        for country in activity.recipient_country.all():
            search_data.search_country_name = '{orig_country_name} {add_country_name} '.format(
        ...
        for region in activity.recipient_region.all():
            search_data.search_region_name = '{orig_region_name} {add_region_name} '.format(
                orig_region_name=search_data.search_region_name or '',
                add_region_name=region.name or ''
            )

        for sector in activity.sector.all():
            search_data.search_sector_name = '{orig_sector_name} {add_sector_name} '.format(
        ...
        for organisation in activity.participating_organisations.all():
            search_data.search_participating_organisation_name = '{orig_organisation_name} {add_organisation_name} '.format(
        ...
        for document in activity.documentlink_set.all():
            search_data.search_documentlink_title = '{orig_documentlink_title} {add_documentlink_title} '.format(
