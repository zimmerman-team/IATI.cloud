...
class country(models.Model):
    ...
    capital_city = models.ForeignKey("city", null=True, related_name='capital_city', null=True, blank=True)
    region = models.ForeignKey(region, null=True, null=True, blank=True)
