    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capital_city', models.ForeignKey(related_name=b'capital_city', blank=True, to='geodata.City', null=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='country',
            name='un_region',
            field=models.ForeignKey(related_name=b'un_region', blank=True, to='geodata.Region', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='country',
            name='unesco_region',
            field=models.ForeignKey(related_name=b'unesco_region', blank=True, to='geodata.Region', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='city',
