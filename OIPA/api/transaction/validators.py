...
def activity_transaction(
        ...
        # country_dict = recipient_country[0]
        # country_list = country_dict['country']
        # validated_country_list = []
        ...
        #             country_item["country"].append(validated_country)
                    
                    # validated_recipient_countries.append(country_item)
                    # countries_codes.append(country_code)
            # validated_country_list = country_item.get('country')

       #  if (len(set(validated_recipient_countries)) > 1 and len(set(validated_recipient_countries)) != len(recipient_country))  or (len(validated_recipient_countries) == 0 ):
       #      if has_existing_recipient_countries:
       #          errors.append(
       #              FieldValidationError(
       #                  "transaction",
