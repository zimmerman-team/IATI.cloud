...
def narratives_validate(narratives, default_lang, activity_id,
                        warnings=[], errors=[], apiField=""):
    # warnings = []
    # errors = []
    validated_data = []
...
def organisation_total_budget_line(
    ...
    narratives = narratives_validate(
        narratives_data,
        total_budget.organisation.default_lang,
...
def organisation_recipient_org_budget_line(
    ...
    narratives = narratives_validate(
        narratives_data,
        recipient_org_budget.organisation.default_lang,
...
def organisation_recipient_country_budget_line(
    ...
    narratives = narratives_validate(
        narratives_data,
        recipient_country_budget.organisation.default_lang,
...
def organisation_recipient_region_budget_line(
    ...
    narratives = narratives_validate(
        narratives_data,
        recipient_region_budget.organisation.default_lang,
...
def organisation_total_expenditure_line(
    ...
    narratives = narratives_validate(
        narratives_data,
        total_expenditure.organisation.default_lang,
...
def organisation_document_link(
    ...
    title_narratives = narratives_validate(
        title_narratives_data,
