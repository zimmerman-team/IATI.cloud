...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('document_link', models.ForeignKey(related_name='documentlinktitles', to='iati_organisation.DocumentLink')),
            ],
        ),
        migrations.CreateModel(
            name='Name',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_currency', models.ForeignKey(to='iati_codelists.Currency', null=True)),
                ('default_lang', models.ForeignKey(to='iati_codelists.Language', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(to='iati_codelists.Currency', null=True)),
                ('organisation', models.ForeignKey(related_name='recipient_country_budget', to='iati_organisation.Organisation')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.DecimalField(default=None, null=True, max_digits=12, decimal_places=2)),
                ('currency', models.ForeignKey(to='iati_codelists.Currency', null=True)),
                ('organisation', models.ForeignKey(related_name='donor_org', to='iati_organisation.Organisation')),
                ('recipient_org', models.ForeignKey(related_name='recieving_org', db_constraint=False, to='iati_organisation.Organisation', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ReportingOrg',
            fields=[
                ...
                ('organisation', models.ForeignKey(related_name='reporting_orgs', to='iati_organisation.Organisation')),
                ('reporting_org', models.ForeignKey(related_name='reported_by_orgs', db_constraint=False, to='iati_organisation.Organisation', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='TotalBudget',
            fields=[
                ...
                ('value', models.DecimalField(default=None, null=True, max_digits=12, decimal_places=2)),
                ('currency', models.ForeignKey(to='iati_codelists.Currency', null=True)),
                ('organisation', models.ForeignKey(related_name='total_budget', to='iati_organisation.Organisation')),
            ],
        ),
        migrations.AddField(
            model_name='name',
            name='organisation',
            field=models.ForeignKey(to='iati_organisation.Organisation'),
        ),
        migrations.AddField(
            model_name='documentlink',
            name='organisation',
            field=models.ForeignKey(related_name='documentlinks', to='iati_organisation.Organisation'),
        ),
        migrations.AddField(
            model_name='documentlink',
