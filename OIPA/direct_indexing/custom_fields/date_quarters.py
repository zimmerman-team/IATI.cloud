IATI_DATE_FIELDS = [
    'activity-date.quarter',
    'budget.period-start.quarter',
    'budget.period-end.quarter',
    'planned-disbursement.period-start.quarter',
    'planned-disbursement.period-end.quarter',
    'transaction.transaction-date.quarter',
    'document-link.document-date.quarter',
    'result.document-link.document-date.quarter',
    'result.indicator.document-link.document-date.quarter',
    'result.indicator.baseline.quarter',
    'result.indicator.baseline.document-link.document-date.quarter',
    'result.indicator.period.period-start.quarter',
    'result.indicator.period.period-end.quarter',
    'result.indicator.period.target.document-link.document-date.quarter',
    'result.indicator.period.actual.document-link.document-date.quarter',
    'crs-add.loan-terms.commitment-date.quarter',
    'crs-add.loan-terms.repayment-first-date.quarter',
    'crs-add.loan-terms.repayment-final-date.quarter',
]
