...
import urllib2
import datetime
from iatip.models import OrganisationIdentifier
import logging
...
class DatasetSyncer():
    ...
    def synchronize_with_iati_api(self, type):
        if type == 1:
            cur_url = "http://www.iatiregistry.org/apip/search/dataset?extras_filetype=activity&all_fields=1&limit=200&offset="

        if type == 2:
            cur_url = "http://www.iatiregistry.org/apip/search/dataset?extras_filetype=organisation&all_fields=1&limit=200&offset="
