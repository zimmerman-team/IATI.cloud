...
class RateBrowser():
    ...
    def prepare_browser(self):
        ...
        # User-Agent
        browser.addheaders = [('User-agent', 'Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.9.0.1) Gecko/2008071615 Fedora/3.0.1-1.fc9 Firefox/3.0.1')]  # NOQA: E501
    ...
    def get_xml_data(self, url, download_url, retry_count=0):
        ...
        try:
            ...
            return etree.fromstring(
                smart_str(response.content, 'utf-8').encode('utf-8')
            )
        except URLError:
            # retry once
