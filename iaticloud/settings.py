...
SOLR_BUDGET_SPLIT_BY_SECTOR = f'{SOLR_URL}/budget_split_by_sector'
SOLR_BUDGET_SPLIT_BY_SECTOR_URL = f'{SOLR_BUDGET_SPLIT_BY_SECTOR}/update'
...
SOLR_FCDO_BUDGET = f'{SOLR_URL}/fcdo_budget'
SOLR_FCDO_BUDGET_URL = f'{SOLR_FCDO_BUDGET}/update'
# DRAFT CORES
...
SOLR_DRAFT_BUDGET_SPLIT_BY_SECTOR = f'{SOLR_URL}/draft_budget_split_by_sector'
SOLR_DRAFT_BUDGET_SPLIT_BY_SECTOR_URL = f'{SOLR_DRAFT_BUDGET_SPLIT_BY_SECTOR}/update'
