<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="lst">
        ...
        <xsl>hierarchy,</xsl>
        <xsl>linked_data_uri,</xsl>
        <xsl>budget_not_provided,</xsl>
        ...
        <xsl>title_narrative_lang,</xsl>
        <xsl>description_narrative,</xsl>
        <xsl>description_narrative_lang,</xsl>
        <xsl>description_type,</xsl>
        ...
        <xsl>participating_org_narrative_lang,</xsl>
        <xsl>participating_org_activity_id,</xsl>
        <xsl>other_identifier_ref,</xsl>
        <xsl>other_identifier_owner_org_ref,</xsl>
        <xsl>other_identifier_owner_org_narrative,</xsl>
        <xsl>other_identifier_owner_org_narrative_lang,</xsl>
        <xsl>activity_status_code,</xsl>
        <xsl>activity_date_iso_date,</xsl>
        <xsl>activity_date_type,</xsl>
        <xsl>activity_date_narrative,</xsl>
        <xsl>activity_date_narrative_lang,</xsl>
        <xsl>contact_info_organisation_narrative,</xsl>
        <xsl>contact_info_organisation_narrative_lang,</xsl>
        <xsl>contact_info_department_narrative,</xsl>
        <xsl>contact_info_department_narrative_lang,</xsl>
        <xsl>contact_info_person_name_narrative,</xsl>
        <xsl>contact_info_person_name_narrative_lang,</xsl>
        <xsl>contact_info_job_title_narrative,</xsl>
        <xsl>contact_info_job_title_narrative_lang,</xsl>
        ...
        <xsl>contact_info_mailing_address_narrative_lang,</xsl>
        <xsl>activity_scope_code,</xsl>
        <xsl>recipient_country_code,</xsl>
        <xsl>recipient_country_percentage,</xsl>
        <xsl>recipient_country_narrative,</xsl>
        <xsl>recipient_country_narrative_lang,</xsl>
        <xsl>recipient_region_code,</xsl>
        <xsl>recipient_region_vocabulary,</xsl>
        <xsl>recipient_region_vocabulary_uri,</xsl>
        <xsl>recipient_region_percentage,</xsl>
        <xsl>recipient_region_narrative,</xsl>
        <xsl>recipient_region_narrative_lang,</xsl>
        ...
        <xsl>location_name_narrative_lang,</xsl>
        <xsl>location_description_narrative,</xsl>
        <xsl>location_description_narrative_lang,</xsl>
        <xsl>location_activity_description_narrative,</xsl>
        <xsl>location_activity_description_narrative_lang,</xsl>
        ...
        <xsl>sector_narrative,</xsl>
        <xsl>sector_narrative_lang,</xsl>
        <xsl>tag_code,</xsl>
        <xsl>tag_vocabulary,</xsl>
        <xsl>tag_vocabulary_uri,</xsl>
        <xsl>tag_narrative,</xsl>
        <xsl>tag_narrative_lang,</xsl>
        ...
        <xsl>humanitarian_scope_narrative_lang,</xsl>
        <xsl>policy_marker_vocabulary,</xsl>
        <xsl>policy_marker_vocabulary_uri,</xsl>
        ...
        <xsl>usd_budget_currency,</xsl>
        <xsl>usd_budget_conversion_rate,</xsl>
        <xsl>usd_budget_value,</xsl>
        ...
        <xsl>usd_planned_disbursement_currency,</xsl>
        <xsl>usd_planned_disbursement_conversion_rate,</xsl>
        <xsl>usd_planned_disbursement_value,</xsl>
        ...
        <xsl>planned_disbursement_provider_org_narrative_lang,</xsl>
        <xsl>planned_disbursement_receiver_org_receiver_activity_id,</xsl>
        <xsl>planned_disbursement_receiver_org_type,</xsl>
        <xsl>planned_disbursement_receiver_org_ref,</xsl>
        <xsl>planned_disbursement_receiver_org_narrative,</xsl>
        <xsl>planned_disbursement_receiver_org_narrative_lang,</xsl>
        ...
        <xsl>usd_transaction_currency,</xsl>
        <xsl>usd_transaction_conversion_rate,</xsl>
        <xsl>usd_transaction_value,</xsl>
        <xsl>transaction_description_narrative,</xsl>
        <xsl>transaction_description_narrative_lang,</xsl>
        ...
        <xsl>document_link_title_narrative_lang,</xsl>
        ...
        <xsl>result_title_narrative_lang,</xsl>
        ...
        <xsl>result_indicator_title_narrative_lang,</xsl>
        <xsl>result_indicator_description_narrative,</xsl>
        <xsl>result_indicator_description_narrative_lang,</xsl>
    ...
    <xsl:template match="doc">
        <xsl:value-of select="date[@name='last_updated_datetime_f']"/>
        ...
        <xsl:value-of select="$delim"/>
        <xsl:value-of select="$delim"/> <!--for linked_data_uri-->
        <xsl:value-of select="$delim"/> <!--for budget_not_provided-->
        ...
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='reporting_org_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='title_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='title_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='description_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='description_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='description_type']/str"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='participating_org_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:value-of select="$delim"/> <!--for participating_org_activity_id-->
        ...
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='other_identifier_owner_org_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='activity_date_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='activity_date_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='contact_info_organisation_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='contact_info_organisation_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='contact_info_department_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='contact_info_department_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='contact_info_person_name_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='contact_info_person_name_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='contact_info_job_title_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='contact_info_job_title_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='contact_info_mailing_address_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='recipient_country_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='recipient_country_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='recipient_region_code']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='recipient_region_vocabulary']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='recipient_region_vocabulary_uri']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='recipient_region_percentage']/double"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='recipient_region_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='recipient_region_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='location_name_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='location_description_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='location_description_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='location_activity_description_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='location_activity_description_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='sector_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='sector_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='tag_code']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='tag_vocabulary']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='tag_vocabulary_uri']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='tag_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='tag_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='humanitarian_scope_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='policy_marker_vocabulary']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='policy_marker_vocabulary_uri']/str"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl>USD</xsl>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='budget_usd_conversion_rate']/double"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='budget_value_usd']/double"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl>USD</xsl>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='planned_disbursement_usd_conversion_rate']/double"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='planned_disbursement_value_usd']/double"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='planned_disbursement_provider_org_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='planned_disbursement_receiver_org_provider_activity_id']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='planned_disbursement_receiver_org_type']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='planned_disbursement_receiver_org_ref']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='planned_disbursement_receiver_org_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='planned_disbursement_receiver_org_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl>USD</xsl>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='transaction_usd_conversion_rate']/double"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='transaction_value_usd']/double"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='transaction_description_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='transaction_description_lang']/str"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='document_link_title_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='result_title_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        ...
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='result_indicator_title_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='result_indicator_description_narrative']/str"/>
        <xsl:value-of select="$delim"/>
        <xsl:apply-templates select="arr[@name='result_indicator_description_narrative_lang']/str"/>
        <xsl:value-of select="$delim"/>
